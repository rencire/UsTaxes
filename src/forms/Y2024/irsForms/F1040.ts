...
export default class F1040 extends F1040Base {
    ...
    if (
      ...
      if (allowances > 0) {
        if (
          ...
          return l4a + allowances * 1700 // TODO double check if need to update
        } else {
          return l4a + allowances * 1350 // TODO double check if need to update
        }
      } else {
        return l4a
      }
  ...
  // TODO: might need to update this for 2024?
  l27 = (): number =>
